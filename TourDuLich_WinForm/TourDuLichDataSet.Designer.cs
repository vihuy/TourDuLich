...
namespace TourDuLich_WinForm {
    ...
    public partial class TourDuLichDataSet : global::System.Data.DataSet {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public NhanVienRow AddNhanVienRow(string HoTen, bool GioiTinh, System.DateTime NgaySinh, string SoDT, string CMND, string DiaChi, bool TrangThai) {
...
namespace TourDuLich_WinForm.TourDuLichDataSetTableAdapters {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NhanVien] WHERE (([MaNV] = @Original_MaNV) AND ([HoTen] = @Original_HoTen) AND ([GioiTinh] = @Original_GioiTinh) AND ([NgaySinh] = @Original_NgaySinh) AND ([SoDT] = @Original_SoDT) AND ([CMND] = @Original_CMND) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([TrangThai] = @Original_TrangThai))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([HoTen], [GioiTinh], [NgaySinh], [SoDT], [CMND], [DiaChi], [TrangThai]) VALUES (@HoTen, @GioiTinh, @NgaySinh, @SoDT, @CMND, @DiaChi, @TrangThai);
SELECT MaNV, HoTen, GioiTinh, NgaySinh, SoDT, CMND, DiaChi, TrangThai FROM NhanVien WHERE (MaNV = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [HoTen] = @HoTen, [GioiTinh] = @GioiTinh, [NgaySinh] = @NgaySinh, [SoDT] = @SoDT, [CMND] = @CMND, [DiaChi] = @DiaChi, [TrangThai] = @TrangThai WHERE (([MaNV] = @Original_MaNV) AND ([HoTen] = @Original_HoTen) AND ([GioiTinh] = @Original_GioiTinh) AND ([NgaySinh] = @Original_NgaySinh) AND ([SoDT] = @Original_SoDT) AND ([CMND] = @Original_CMND) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ([TrangThai] = @Original_TrangThai));
SELECT MaNV, HoTen, GioiTinh, NgaySinh, SoDT, CMND, DiaChi, TrangThai FROM NhanVien WHERE (MaNV = @MaNV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNV, HoTen, GioiTinh, NgaySinh, SoDT, CMND, DiaChi, TrangThai FROM dbo.Nh" +
                "anVien";
        ...
        public virtual int Delete(int Original_MaNV, string Original_HoTen, bool Original_GioiTinh, System.DateTime Original_NgaySinh, string Original_SoDT, string Original_CMND, string Original_DiaChi, bool Original_TrangThai) {
        ...
        public virtual int Insert(string HoTen, bool GioiTinh, System.DateTime NgaySinh, string SoDT, string CMND, string DiaChi, bool TrangThai) {
            if ((HoTen == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HoTen, bool GioiTinh, System.DateTime NgaySinh, string SoDT, string CMND, string DiaChi, bool TrangThai, int Original_MaNV, string Original_HoTen, bool Original_GioiTinh, System.DateTime Original_NgaySinh, string Original_SoDT, string Original_CMND, string Original_DiaChi, bool Original_TrangThai) {
            return this.Update(HoTen, GioiTinh, NgaySinh, SoDT, CMND, DiaChi, TrangThai, Original_MaNV, Original_HoTen, Original_GioiTinh, Original_NgaySinh, Original_SoDT, Original_CMND, Original_DiaChi, Original_TrangThai, Original_MaNV);
        }
    }
